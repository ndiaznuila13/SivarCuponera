...
import AppLayout from './components/layout/Layout' // Rename to avoid conflict with variable if any, though likely not needed. Let's stick to Layout.
import CuponCard from './components/cupones/CuponCard' // My refactor
import './App.css'
